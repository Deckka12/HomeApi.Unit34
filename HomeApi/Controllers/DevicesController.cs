...
namespace HomeApi.Controllers
{
    ...
    public class DevicesController : ControllerBase
    {
        ...
        public async Task<IActionResult> Delete (Device device) {
            var setDevice = await _devices.GetDeviceById(device.Id);
            if(setDevice == null)
                return StatusCode(400, $"Ошибка: Устройство {device.Name} не существует.");
            await _devices.DeleteDevice(setDevice);
            return StatusCode(201, $"Устройство {setDevice.Name} удалено.");
        }
        /// <summary>
